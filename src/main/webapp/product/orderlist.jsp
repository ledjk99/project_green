...
<%--연재씨한테 넘겨받은 수취인정보, 상품정보를 DB에 먼저 입력하는게 필요할듯.....
수량정보는 orderitems에 있는데...??
DB입력이 안되면 불러올 수가 없음......T.T  --%>

<%--테스트 페이지 http://localhost/product/orderlist.jsp?order_id=1--%>
<%
    // 주문 ID 파라미터 가져오기
    String order_id_param = request.getParameter("order_id");
    // 주문 ID 확인
